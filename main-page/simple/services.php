...
$query2 = "insert into yang (id, question, answer, reg_date) values (2,'5/8 + 9/10','$answer2',0)";
$query3 = "insert into yang (id, question, answer, reg_date) values (3,'9/4 - 2/3','$answer3',0)";
$query4 = "insert into yang (id, question, answer, reg_date) values (4,'2/3 + 5/8','$answer4',0)";
$query5 = "insert into yang (id, question, answer, reg_date) values (5,'54/53 - 5/53','$answer5',0)";
$query6 = "insert into yang (id, question, answer, reg_date) values (6,'12/3 + 16/2','$answer6',0)";
$query7 = "insert into yang (id, question, answer, reg_date) values (7,'12/5 + 16/3','$answer7',0)";
$query8 = "insert into yang (id, question, answer, reg_date) values (8,'8/3 + 9/2','$answer8',0)";
$query9 = "insert into yang (id, question, answer, reg_date) values (9,'12/3 - 16/2','$answer9',0)";
$query10 = "insert into yang (id, question, answer, reg_date) values (10,'8/3 - 2/2','$answer10',0)";
$resultset = mysqli_query($connection,$query1)  or die(mysql_error())    ;
$resultset = mysqli_query($connection,$query2)  or die(mysql_error())    ;
$resultset = mysqli_query($connection,$query3)  or die(mysql_error())    ;
$resultset = mysqli_query($connection,$query4)  or die(mysql_error())    ;
$resultset = mysqli_query($connection,$query5)  or die(mysql_error())    ;
$resultset = mysqli_query($connection,$query6)  or die(mysql_error())    ;
$resultset = mysqli_query($connection,$query7)  or die(mysql_error())    ;
$resultset = mysqli_query($connection,$query8)  or die(mysql_error())    ;
$resultset = mysqli_query($connection,$query9)  or die(mysql_error())    ;
$resultset = mysqli_query($connection,$query10)  or die(mysql_error())    ;
?>

		...
		<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
				<div class="container">
						...
						<div class="navbar-header">
								...
								<a class="navbar-brand" href="https://akademia3308.herokuapp.com"><span class="glyphicon glyphicon-fire"></span> Akademia</a>
						</div>
						<!-- Navbar links -->
						<div class="collapse navbar-collapse" id="navbar">
								<ul class="nav navbar-nav">
										<li>
												<a href="https://akademia3308.herokuapp.com/lit-page.html">Back to Literature Topics</a>
										</li>
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
						<div class="fh5co-intro fh5co-table-cell">
							<h1 class="text-center">Eastern Literature</h1>
							<p>Made with love by the fine folks at Akademia</p>
						</div>
					</div>
				</div>
			</div>
	...
	<footer id="fh5co-footer">
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<h3>About Us</h3>
					<p>Akademia strives to teach children learning topics through interactive lessons.</p>
</div>
				<div class="col-md-3 col-md-push-1">
					<h3>Quick Links</h3>
					<ul>
						<li><a href="javascript:history.back()">Back to Literature Topics</a></li>
			...
			<div class="row">
				<div class="col-md-12 fh5co-copyright text-center">
					<p><small>&copy; 2016 Free HTML5 Simple. All Rights Reserved. </small></p>
				</div>
			</div>
		</div>
	</footer>
